...
AS $$
DECLARE
  project_url TEXT := 'https://pqsakekxwvapwnojldeh.supabase.com';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBxc2FrZWt4d3ZhcHdub2psZGVoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxMjgzNzg0NCwiZXhwIjoyMDI4NDEzODQ0fQ.fNsW2NATtpB-laBWfxVr3rRxuyW9HLK8Yg19sDlk_Qo'; -- full access needed for http request to storage
